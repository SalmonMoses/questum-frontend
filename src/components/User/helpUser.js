...
export default function Help() {
                ...
                <main className={classes.content}>
                        ...
                        <Paper className={classes.paper}>
                                <Container className={classes.cont}>
                                        ...
                                        <Divider />
                                        <Typography variant="h4" align="center"><b><span>Group Member</span></b></Typography>

                                        <Typography variant="h5" align="center"><b><span>Account
            Management </span></b></Typography>
        ...
        receive an email at that address.</span></Typography>
                                        ...
                                        <Typography variant="body1"><span>If your registered address is correct, but the message
        ...
        login information.</span></Typography>
        ...
        “Settings” in the menu on the left or on </span><span>the gear sign <span>at the top of the
            ...
            “General Settings’ section.</span></span></Typography>
        ...
        check the leaderboard.</span></Typography>
                                        ...
                                        <Typography variant="body1"><span>·<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        </span></span><u><span>Deleting your account</span></u></Typography>

                                        <Typography variant="body1"><span>Before do anything, please be aware that
                                        deletion cannot be undone. Once you delete your content, its contents are gone
        forever. </span></Typography>

                                        <Typography variant="body1"><span>To delete your entire account, go to the
                                        “Profile” page in the menu on the left and click the “Delete my account” button
        at the bottom of the page. </span></Typography>

                                        <Typography variant="h5" align="center"><b><span>Quests</span></b></Typography>

                                        <Typography variant="body1"><span>You can monitor the progress of the quests
        ...
        administrator and be ready to move on. Good luck!</span></Typography>
